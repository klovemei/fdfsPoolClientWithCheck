...
public class StorageClientImpl extends AbstractClient implements StorageClient {
    ...
    public StorageClientImpl(String address) throws IOException {
        super();
    ...
    public StorageClientImpl(String address, Integer connectTimeout, Integer networkTimeout) throws IOException {
        this(address);
    ...
    @Override
    public Result<String> upload(InputStream inputStream, String fileName, byte storePathIndex) throws IOException {
        Socket socket = getSocket();
        UploadStreamCmd uploadCmd = new UploadStreamCmd(inputStream, fileName, storePathIndex);
        return uploadCmd.exec(socket);
    }
